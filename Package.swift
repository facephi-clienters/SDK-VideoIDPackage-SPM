...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:AgoraIO/AgoraLite_iOS.git", .upToNextMinor(from: "4.5.2")),
        ...
        .package(url: "git@github.com:facephi-clienters/FPHISelphidDocumentReaderBundle-SPM.git", .upToNextMinor(from: "2.0.6"))
    ],
    targets: [
        ...
        url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/SDK/FPHISDKVideoIDComponent/2.7.0/videoidComponent.zip",
        checksum: "8c4713b5c63ac12e3988520ee7e048a0efb5bfba630cf67acb5dd38492c5d64b"),
    ]
)
